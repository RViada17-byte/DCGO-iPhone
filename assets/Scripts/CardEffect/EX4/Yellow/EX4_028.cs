...
{
    public class EX4_028 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.None)
            {
                ...
                {
                    return targetPermanent.TopCard.CardNames.Contains("Kyubimon");
                }
            ...
            if (timing == EffectTiming.None)
            {
                ...
                changeCardNamesClass.SetUpICardEffect("Also treated as [Taomon]", CanUseCondition, card);
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                activateClass.SetUpICardEffect("Return 1 Digimon with 6000 DP or less to hand", CanUseCondition, card);
                activateClass.SetUpActivateClass(CanActivateCondition, ActivateCoroutine, -1, false, EffectDiscription());
                cardEffects.Add(activateClass);

                string EffectDiscription()
                {
                    return "[On Play] Return 1 of your opponent's Digimon with 6000 DP or less to its owner's hand.";
                }
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                string EffectDiscription()
                {
                    return "[When Digivolving] Return 1 of your opponent's Digimon with 6000 DP or less to its owner's hand.";
                }
            ...
            if (timing == EffectTiming.OnUseOption)
            {
                ...
                activateClass.SetHashString("DP-2000_EX4_028");
                cardEffects.Add(activateClass);
