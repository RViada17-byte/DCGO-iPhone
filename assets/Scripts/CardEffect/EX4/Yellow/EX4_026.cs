...
{
    public class EX4_026 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.None)
            {
                ...
                {
                    return targetPermanent.TopCard.CardNames.Contains("Renamon");
                }
            ...
            if (timing == EffectTiming.None)
            {
                ...
                changeCardNamesClass.SetUpICardEffect("Also treated as [Kyubimon]", CanUseCondition, card);
            ...
            if (timing == EffectTiming.OnUseOption)
            {
                ...
                activateClass.SetHashString("DP-2000_EX4_026");
                cardEffects.Add(activateClass);
