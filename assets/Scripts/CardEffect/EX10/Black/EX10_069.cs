    ...
    public class EX10_069 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OptionSkill)
            {
                ...
                activateClass.SetUpICardEffect("Play 1 [Sunarizamon]/[Close] from hand or trash, then place in battle area", CanUseCondition, card);
                activateClass.SetUpActivateClass(null, ActivateCoroutine, -1, false, EffectDiscription());
                cardEffects.Add(activateClass);

                string EffectDiscription()
                {
                    return "[Main] You may play 1 [Sunarizamon] or [Close] from your hand or trash without paying the cost. Then, place this card in the battle area.";
                }
                ...
                {
                    return cardSource.EqualsCardName("Sunarizamon") || cardSource.EqualsCardName("Close")
                    ...
                    if (CardEffectCommons.HasMatchConditionOwnersHand(card, CanSelectCardCondition) || CardEffectCommons.HasMatchConditionOwnersCardInTrash(card, CanSelectCardCondition))
                    {
                        ...
                        if (canSelectHand || canSelectTrash)
                        {
                            ...
                            if (fromHand)
                            {
                                ...
                                selectHandEffect.SetUpCustomMessage("Select 1 [Sunarizamon]/[Close] to play.", "The opponent is selecting 1 [Sunarizamon]/[Close] to play.");
                            ...
                            else
                            {
                                ...
                                selectCardEffect.SetUp(
                                    ...
                                    selectCardCoroutine: SelectCardCoroutine,
                                    afterSelectCardCoroutine: null,
                                    message: "Select 1 [Sunarizamon]/[Close] to play.",
                                    maxCount: 1,
                                    canEndNotMax: false,
                                    isShowOpponent: true,
                                ...
                                selectCardEffect.SetUpCustomMessage("Select 1 [Sunarizamon]/[Close] to play.", "The opponent is selecting 1 [Sunarizamon]/[Close] to play.");
            ...
            {
                ActivateClass activateClass = new ActivateClass();
                activateClass.SetUpICardEffect("1 of your [Rock] or [Mineral] trait Digimon may digivolve", CanUseCondition, card);
                activateClass.SetUpActivateClass(CanActivateCondition, ActivateCoroutine, -1, true, EffectDiscription());
                cardEffects.Add(activateClass);

                string EffectDiscription()
                {
                    return "[Your Turn] When any of your [Close] suspend, <Delay> (By trashing this card after the placing turn, activate the effect below.)\r\n・1 of your [Rock] or [Mineral] trait Digimon may digivolve into a [Rock] or [Mineral] and [LIBERATOR] trait Digimon card in the hand with the digivolution cost reduced by 3.";
                }
            ...
            if (timing == EffectTiming.SecuritySkill)
            {
                CardEffectCommons.AddActivateMainOptionSecurityEffect(
                    ...
                    effectName: "Play 1 [Sunarizamon]/[Close] from hand or trash, then place in battle area");
            }
