...
{
    public class EX11_015 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                activateClass.SetUpICardEffect("Play 1 [Suzune Kazuki] from hand", CanUseCondition, card);
                ...
                bool IsTamerCardCondition(CardSource cardSource)
                {
                    return cardSource.IsTamer
                        && cardSource.EqualsCardName("Suzune Kazuki") 
