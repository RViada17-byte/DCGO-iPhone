...
{
    public class BT12_087 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnStartMainPhase)
            {
                ...
                {
                    return "[Start of Your Main Phase] By placing 1 of your Digimon cards with <Save> in its text from your hand under this Tamer, <Draw 1>. (Draw 1 card from your deck.)";
                }
            ...
            if (timing == EffectTiming.BeforePayCost)
            {
                ...
                activateClass.SetUpActivateClass(CanActivateCondition, ActivateCoroutine, -1, true, EffectDiscription());
                activateClass.SetHashString("DigivolutionCost-1_BT12_087");
                cardEffects.Add(activateClass);
