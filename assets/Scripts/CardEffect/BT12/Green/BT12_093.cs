...
{
    public class BT12_093 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnStartMainPhase)
            {
                ...
                activateClass.SetUpICardEffect("Place 1 card under this Tamer from hand to increase your Digimon's DP by 2000", CanUseCondition, card);
                activateClass.SetUpActivateClass(CanActivateCondition, ActivateCoroutine, -1, true, EffectDiscription());
                cardEffects.Add(activateClass);

                string EffectDiscription()
                {
                    return "[Start of Your Main Phase] By placing 1 Digimon card with <Save> in its text from your hand under this Tamer, 1 of your Digimon gets +2000 DP for the turn.";
                }
            ...
            if (timing == EffectTiming.BeforePayCost)
            {
                ...
                activateClass.SetUpActivateClass(CanActivateCondition, ActivateCoroutine, -1, true, EffectDiscription());
                activateClass.SetHashString("DigivolutionCost-1_BT12_093");
                cardEffects.Add(activateClass);
