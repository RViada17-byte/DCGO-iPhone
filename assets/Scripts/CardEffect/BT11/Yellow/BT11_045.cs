...
{
    public class BT11_045 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                {
                    return "[When Digivolving] If you have 5 or fewer cards in your security stack, <Recovery +1 (Deck)>. (Place the top card of your deck on top of your security stack.)";
                }
            ...
            if (timing == EffectTiming.OnLoseSecurity)
            {
                ...
                string EffectDiscription()
                {
                    return "[Opponent's Turn] When a card is removed from your security stack, 1 of your opponent's Digimon gets -4000 DP for the turn.";
                }
