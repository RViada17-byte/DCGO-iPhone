...
{
    public class BT11_099 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.None)
            {
                ...
                bool CanUseCondition(Hashtable hashtable)
                {
                    ...
                    permanent.TopCard.CardColors.Contains(CardColor.Blue) && permanent.IsTamer))
                    {
                        return true;
                    }
            ...
            if (timing == EffectTiming.OptionSkill)
            {
                ...
                {
                    return "[Main] Trash the top 3 digivolution cards of 1 of your opponent's Digimon. Then, return 1 of your opponent's Digimon with no digivolution cards to its owner's hand.";
                }
            ...
            if (timing == EffectTiming.SecuritySkill)
            {
                CardEffectCommons.AddActivateMainOptionSecurityEffect(
                    ...
                    effectName: $"Trash digivolution cards and return 1 Digimon with no digivolution cards to hand");
            }
