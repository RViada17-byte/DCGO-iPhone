...
{
    public class BT11_110 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.None)
            {
                ...
                bool CanUseCondition(Hashtable hashtable)
                {
                    ...
                    permanent.TopCard.CardColors.Contains(CardColor.Purple) && permanent.IsTamer))
                    {
                        return true;
                    }
            ...
            if (timing == EffectTiming.OptionSkill)
            {
                ...
                {
                    return "[Main] Delete 3 of your opponent's unsuspended level 5 or lower Digimon.";
                }
            ...
            if (timing == EffectTiming.SecuritySkill)
            {
                CardEffectCommons.AddActivateMainOptionSecurityEffect(
                    ...
                    effectName: $"Delete 3 level 5 or lower unsuspended Digimon");
            }
