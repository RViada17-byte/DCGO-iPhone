...
{
    public class ST17_12 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OptionSkill)
            {
                ...
                {
                    return "[Main] Suspend 1 of your opponent's Digimon. Then, return 1 of your opponent's suspended Digimon to the bottom of its owner's deck. 1 of your opponent's Digimon can't unsuspend until the end of your opponent's turn.";
                }
            ...
            if (timing == EffectTiming.SecuritySkill)
            {
                CardEffectCommons.AddActivateMainOptionSecurityEffect(
                    ...
                    effectName: $"Suspend 1 Digimon and return a suspended Digimon to bottom of deck and prevent 1 Digimon from unsuspending.");
            }
