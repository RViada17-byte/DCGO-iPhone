...
public class BT7_026 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnEnterFieldAnyone)
        {
            ...
            {
                return "[On Play] If you have a Tamer in play, gain 2 memory. If you don't have a Tamer in play, you may play 1 blue Tamer card from your hand without paying its memory cost.";
            }
        ...
        if (timing == EffectTiming.OnUnTappedAnyone)
        {
            ...
            activateClass.SetHashString("Memory+1_BT7_026");
            cardEffects.Add(activateClass);
