...
{
    public class EX2_021 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                {
                    return "[When Digivolving] Reveal the top 3 cards of your deck. Add 1 Option card with [Plug-In] in its name among them to your hand. Place the remaining cards at the bottom of your deck in any order.";
                }
            ...
            if (timing == EffectTiming.OnUseOption)
            {
                ...
                activateClass.SetHashString("DP-2000_EX2_021");
                cardEffects.Add(activateClass);
