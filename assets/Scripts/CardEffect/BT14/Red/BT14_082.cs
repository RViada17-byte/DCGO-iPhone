...
{
    public class BT14_082 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnStartMainPhase)
            {
                ...
                {
                    return "[Start of Your Main Phase] 1 of your Digimon with the [Vaccine] trait gets +2000 DP for the turn.";
                }
            ...
            if (timing == EffectTiming.OnLoseSecurity)
            {
                ...
                string EffectDiscription()
                {
                    return "[Your Turn] When a card is removed from your opponent's security stack, by suspending this Tamer, gain 1 memory.";
                }
