...
public class EX5_032 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.None)
        {
            ...
            {
                return targetPermanent.TopCard.ContainsCardName("Leomon") && targetPermanent.TopCard.HasLevel && targetPermanent.TopCard.Level == 4;
            }
        ...
        if (timing == EffectTiming.OnEnterFieldAnyone)
        {
            ...
            {
                return "[On Play] 1 of your opponent's Digimon gets -3000 DP until the end of their turn.";
            }
        ...
        if (timing == EffectTiming.OnEnterFieldAnyone)
        {
            ...
            string EffectDiscription()
            {
                return "[When Digivolving] 1 of your opponent's Digimon gets -3000 DP until the end of their turn.";
            }
