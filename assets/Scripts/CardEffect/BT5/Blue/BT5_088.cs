...
using System;
using Photon.Pun;
public class BT5_088 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnStartTurn)
        {
            ...
            {
                return "[Start of Your Turn] If your opponent has a Digimon with no digivolution cards, gain 2 memory.";
            }
        ...
        if (timing == EffectTiming.OnAllyAttack)
        {
            ...
            string EffectDiscription()
            {
                return "[Your Turn] When you attack with a blue Digimon, you may suspend this Tamer to trash up to 2 digivolution cards from the bottom of 1 of your opponent's Digimon.";
            }
