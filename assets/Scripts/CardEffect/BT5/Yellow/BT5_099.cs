...
public class BT5_099 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OptionSkill)
        {
            ...
            {
                return "[Main] For each Digimon you have in play, activate the effect below. - 1 of your opponent's Digimon gets -3000 DP for the turn.";
            }
            ...
            {
                int count = card.Owner.GetBattleAreaDigimons().Count;
