...
{
    public class EX8_034 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                activateClass.SetUpICardEffect("Play 1 NSo Digimon card with a play cost 3 or less from your hand",
                ...
                {
                    return "[When Digivolving] You may play 1 [NSo] trait Digimon card with a play cost of 3 or less from your hand without paying the cost.";
                }
                ...
                bool CanSelectCardCondition(CardSource cardSource)
                {
                    return cardSource.IsDigimon &&
                           ...
                           cardSource.HasPlayCost && cardSource.GetCostItself <= 3;
                }
            ...
            {
                ActivateClass activateClass = new ActivateClass();
                activateClass.SetUpICardEffect("2 Opponent's Digimon gain Security Attack -1", CanUseCondition, card);
