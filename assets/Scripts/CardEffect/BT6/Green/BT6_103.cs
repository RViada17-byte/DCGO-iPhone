...
using System;
using Photon.Pun;
public class BT6_103 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OptionSkill)
        {
            ...
            {
                return "[Main] Suspend all of your opponent's Digimon. Then, gain 1 memory for each of your opponent's suspended Digimon.";
            }
            ...
            IEnumerator ActivateCoroutine(Hashtable _hashtable)
            {
                ...
                yield return ContinuousController.instance.StartCoroutine(card.Owner.AddMemory(card.Owner.Enemy.GetBattleAreaDigimons().Count((permanent) => permanent.IsSuspended), activateClass));
            }
        }
