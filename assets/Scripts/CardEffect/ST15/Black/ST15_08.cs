...
public class ST15_08 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.SecuritySkill)
        {
            ...
            {
                return "[Security] You may play 1 [Agumon] or 1 Tamer card with [Tai Kamiya] in its name from your hand or trash without paying the cost.";
            }
        ...
        if (timing == EffectTiming.OnAttackTargetChanged)
        {
            ...
            activateClass.SetHashString("Memory+1_ST15_08");
            cardEffects.Add(activateClass);
