...
{
    public class BT21_088 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnStartMainPhase)
            {
                ...
                {
                    return "[Start of Your Main Phase] By placing 1 Digimon card with <Save> in its text or the [Hero] trait from your hand under this Tamer, <Draw 1> and gain 1 memory.";
                }
                ...
                bool CanSelectCardCondition(CardSource cardSource)
                {
                    ...
                    {
                        if (cardSource.HasSaveText || cardSource.EqualsTraits("Hero"))
                        {
                            return true;
                        }
                    }
