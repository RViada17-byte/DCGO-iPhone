...
{
    public class BT19_033 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                activateClass.SetUpICardEffect("Digivolve into [JaegerDorulumon] from under your Tamers", CanUseCondition, card);
                ...
                {
                    return cardSource.IsDigimon && cardSource.EqualsCardName("JaegerDorulumon") &&
