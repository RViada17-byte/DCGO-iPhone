...
{
    public class BT19_052 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            int maxCost()
            {
                return 2 + (card.Owner.SecurityCards.Count(cardSource => !cardSource.IsFlipped)*2);
            }
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                activateClass.SetUpICardEffect("Delete 1 Digimon with a play cost of 2 or less", CanUseCondition, card);
                activateClass.SetUpActivateClass(CanActivateCondition, ActivateCoroutine, -1, false, EffectDiscription());
                cardEffects.Add(activateClass);

                string EffectDiscription()
                {
                    return "[On Play] Delete 1 of your opponent's Digimon with a play cost of 2 or less. For each of your face up security cards, add 2 to this effect's play cost.";
                }
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                string EffectDiscription()
                {
                    return "[When Digivolving] Delete 1 of your opponent's Digimon with a play cost of 2 or less. For each of your face up security cards, add 2 to this effect's play cost.";
                }
