...
{
    public class BT19_051 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.None)
            {
                ...
                changeCardNamesForDigiXrosClass.SetUpICardEffect("Also treated as [Ballistamon] for a DigiXros", CanUseCondition, card);
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                activateClass.SetUpICardEffect("1 of your Digimon can't be returned to the hand or deck and gets +3000 DP",
                ...
                IEnumerator ActivateCoroutine(Hashtable hashtable)
                {
                    ...
                    selectPermanentEffect.SetUpCustomMessage(
                        "Select 1 Digimon that will get DP +3000 and can't be returned to the hand or deck.",
                        "The opponent is selecting 1 Digimon that will get DP +3000 and can't be returned to the hand or deck.");
