...
public class BT8_108 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OptionSkill)
        {
            ...
            {
                return "[Main] Trash the top 2 cards of your deck and <Draw 1>. (Draw 1 card from your deck.) Then, place this card in your Battle Area.";
            }
