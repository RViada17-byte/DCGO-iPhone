...
public class BT8_095 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OptionSkill)
        {
            ...
            {
                return "[Main] 1 of your Digimon with 2 or more colors gains <Security Attack +1> for the turn. (This Digimon checks 1 additional security card.)";
            }
        ...
        if (timing == EffectTiming.SecuritySkill)
        {
            ...
            string EffectDiscription()
            {
                return "[Security] Delete 1 of your opponent's Digimon with <Blocker>.";
            }
