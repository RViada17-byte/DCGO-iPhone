...
public class BT8_086 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnAllyAttack)
        {
            ...
            {
                return "[Your Turn] When you attack with a Digimon that has [Gammamon] in its name or is level 5 or higher, you may suspend this Tamer to have 1 of your Digimon get +2000 DP for the turn.";
            }
            ...
            bool PermanentCondition(Permanent permanent)
            {
                ...
                {
                    if (permanent.TopCard.ContainsCardName("Gammamon"))
                    {
                        return true;
                    }
