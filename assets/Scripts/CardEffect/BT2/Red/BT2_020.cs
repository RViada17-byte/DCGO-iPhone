...
using System;
using Photon.Pun;
public class BT2_020 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnEnterFieldAnyone)
        {
            ...
            {
                return "[When Digivolving] If you have a red Tamer in play, delete 1 of your opponent's Digimon with 6000 DP or less.";
            }
        ...
        if (timing == EffectTiming.OnAllyAttack)
        {
            ...
            string EffectDiscription()
            {
                return "[When Attacking] Trash 1 of your opponent's security cards for every 10 cards in their trash.";
            }
