...
using System;
using Photon.Pun;
public class BT2_021 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnUnTappedAnyone)
        {
            ...
            activateClass.SetHashString("Draw1_BT2_021");
            cardEffects.Add(activateClass);

            string EffectDiscription()
            {
                return "[Your Turn][Once Per Turn] When this Digimon becomes unsuspended during your main phase, trigger <Draw 1>. (Draw 1 card from your deck.)";
            }
