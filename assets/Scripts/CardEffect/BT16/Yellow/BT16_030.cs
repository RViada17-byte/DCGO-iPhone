...
{
    public class BT16_030 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.None)
            {
                ...
                {
                    if (targetPermanent.TopCard.CardNames.Contains("Nyaromon"))
                    {
                        return true;
                    }
                    return false;
            ...
            if (timing == EffectTiming.OnStartMainPhase)
            {
                ...
                {
                    if (cardSource.CardTraits.Contains("Holy Beast") || cardSource.CardTraits.Contains("HolyBeast") || cardSource.CardTraits.Contains("Free"))
                    {
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                string EffectDiscription()
                {
                    return "[On Play] If it's your turn, 1 of your Digimon may digivolve into a level 4 Digimon card with the [Holy Beast] or [Free] trait from your trash with the digivolution cost reduced by 1.";
                }
