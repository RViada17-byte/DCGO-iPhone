...
{
    public class BT16_084 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnStartMainPhase)
            {
                ...
                activateClass.SetUpICardEffect("You may play 1 [Hawkmon] or [Salamon] from your hand.", CanUseCondition, card);
                ...
                {
                    if (cardSource.CardNames.Contains("Salamon") || cardSource.CardNames.Contains("Hawkmon"))
                    {
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                IEnumerator ActivateCoroutine(Hashtable hashtable)
                {
                    ...
                    if (CardEffectCommons.IsJogress(hashtable))
                    {
                        ...
                        selectPermanentEffect.SetUpCustomMessage("Select 1 Digimon to give -3000 DP.", "The opponent is selecting 1 Digimon to give -3000 DP.");
                    ...
                    IEnumerator SelectPermanentCoroutine(Permanent permanent)
                    {
                        if (permanent != null)
                        {
                            ...
                            {
                                yield return ContinuousController.instance.StartCoroutine(CardEffectCommons.ChangeDigimonDP(permanent, -3000, EffectDuration.UntilEachTurnEnd, activateClass));
                            }
                        }
                    }
                }
