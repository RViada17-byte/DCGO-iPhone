...
{
    public class BT18_074 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.None)
            {
                ...
                DigiXrosCondition GetDigiXros(CardSource cardSource)
                {
                    if (cardSource == card)
                    {
                        DigiXrosConditionElement elementMercurymon =
                            new DigiXrosConditionElement(CanSelectCardCondition, "Mercurymon");
                        ...
                        bool CanSelectCardCondition(CardSource conditionCardSource)
                        {
                            if (conditionCardSource != null)
                            {
                                if (conditionCardSource.Owner == card.Owner)
                                {
                                    ...
                                    {
                                        if (conditionCardSource.CardNames_DigiXros.Contains("Mercurymon"))
                                        {
                                            return true;
                                        }
                                    }
                        ...
                        DigiXrosConditionElement elementSephirothmon =
                            new DigiXrosConditionElement(CanSelectCardCondition1, "Sephirothmon");
                        ...
                        bool CanSelectCardCondition1(CardSource conditionCardSource)
                        {
                            if (conditionCardSource != null)
                            {
                                if (conditionCardSource.Owner == card.Owner)
                                {
                                    if (conditionCardSource.IsDigimon)
                                    {
                                        if (conditionCardSource.CardNames_DigiXros.Contains("Sephirothmon"))
                                        {
                                            return true;
                                        }
                                    }
                        ...
                        List<DigiXrosConditionElement> elements = new List<DigiXrosConditionElement>()
                            { elementMercurymon, elementSephirothmon };
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                {
                    return "[On Play] You may reveal the top 3 cards of your deck. Play 1 black card with a play cost of 7 or less among them without paying the cost. Trash the rest.";
                }
                ...
                IEnumerator ActivateCoroutine(Hashtable _hashtable)
                {
                    ...
                    yield return ContinuousController.instance.StartCoroutine(CardEffectCommons.SimplifiedRevealDeckTopCardsAndSelect(
                        ...
                        new SimplifiedSelectCardConditionClass(
                            ...
                            message: "Select 1 black card with a play cost of 7 or less.",
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                string EffectDiscription()
                {
                    return "[When Digivolving] You may reveal the top 3 cards of your deck. Play 1 black card with a play cost of 7 or less among them without paying the cost. Trash the rest.";
                }
            ...
            if (timing == EffectTiming.WhenRemoveField)
            {
                ...
                string EffectDiscription()
                {
                    return "[All Turns] When this Digimon would leave the battle area, you may return to the hand or play 1 level 4 or lower black Digimon card from this Digimon's digivolution cards without paying the cost.";
                }
