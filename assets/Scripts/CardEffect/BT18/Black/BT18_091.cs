...
{
    public class BT18_091 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnAttackTargetChanged)
            {
                ...
                {
                    return
                        "[All Turns] (Once Per Turn) When an attack target is changed, you may play 1 Tamer card with inherited effects from your hand without paying the cost.";
                }
