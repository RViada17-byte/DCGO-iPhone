...
{
    public class BT18_087 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnLoseSecurity)
            {
                ...
                {
                    return "[All Turns] When an opponent's security card is removed, by suspending this Tamer, delete 1 of your opponent's Digimon with 4000 DP or less.";
                }
