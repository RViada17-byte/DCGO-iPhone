...
{
    public class BT18_022 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.None)
            {
                bool PermanentCondition(Permanent targetPermanent)
                {
                    return targetPermanent.TopCard.EqualsCardName("Korikakumon");
                }
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                {
                    return "[When Digivolving] Trash the bottom 2 digivolution cards of 1 of your opponent's Digimon.";
                }
            ...
            if (timing == EffectTiming.WhenRemoveField)
            {
                ...
                activateClass.SetHashString("PlayTamer_BT18_022");
                cardEffects.Add(activateClass);
