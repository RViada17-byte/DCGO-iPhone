...
{
    public class BT18_048 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            // Any green or red tamer
            if (timing == EffectTiming.None)
            {
                bool PermanentCondition(Permanent targetPermanent)
                {
                    return targetPermanent.IsTamer && (targetPermanent.TopCard.CardColors.Contains(CardColor.Green) ||
            ...
            if (timing == EffectTiming.None)
            {
                bool PermanentCondition(Permanent targetPermanent)
                {
                    return targetPermanent.TopCard.EqualsCardName("Zephyrmon");
                }
            ...
            if (timing == EffectTiming.OnAllyAttack)
            {
                ...
                activateClass.SetUpActivateClass(CanActivateCondition, ActivateCoroutine, 1, true,
                    EffectDescription());
                activateClass.SetHashString("Attacking_BT18-048");
                cardEffects.Add(activateClass);
            ...
            if (timing == EffectTiming.WhenRemoveField)
            {
                ...
                activateClass.SetHashString("PlayTamer_BT18_048");
                cardEffects.Add(activateClass);
