...
{
    public class BT18_050 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            bool YourDigimon(Permanent permanent)
            {
                if (CardEffectCommons.IsPermanentExistsOnOwnerBattleAreaDigimon(permanent, card))
                    return permanent.TopCard.Level <= 4 && permanent.TopCard.HasLevel &&
                            permanent.TopCard.HasPlantTraits;
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                {
                    return "[On Play] You may unsuspend 1 of your level 4 or lower Digimon with [Vegetation] or [Plant] in one of its traits.";
                }
                ...
                {
                    if (CardEffectCommons.IsExistOnBattleAreaDigimon(card))
                        return CardEffectCommons.HasMatchConditionPermanent(YourDigimon);
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                string EffectDiscription()
                {
                    return "[When Digivolving] You may unsuspend 1 of your level 4 or lower Digimon with [Vegetation] or [Plant] in one of its traits.";
                }
            ...
            if (timing == EffectTiming.OnAllyAttack)
            {
                ...
                activateClass.SetHashString("Suspend_BT18_050");
