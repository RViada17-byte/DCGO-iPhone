...
{
    public class LM_033 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OptionSkill)
            {
                ...
                {
                    return "[Main] Reveal the top 3 cards of your deck. Add 1 red or black Digimon card among them to the hand. Return the rest to the bottom of deck. Then, place this card in the battle area.";
                }
                ...
                bool CanSelectCardCondition(CardSource cardSource)
                {
                    ...
                    {
                        if (cardSource.CardColors.Contains(CardColor.Red) || cardSource.CardColors.Contains(CardColor.Black))
                        {
                            return true;
                        }
                    }
                ...
                IEnumerator ActivateCoroutine(Hashtable _hashtable)
                {
                    ...
                    new SelectCardConditionClass[]
                    {
                        new SelectCardConditionClass(
                            ...
                            message: "Select 1 red or black Digimon card.",
                            maxCount: 1,
                            canEndNotMax:false,
