...
{
    public class LM_056 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.None)
            {
                ...
                bool CanUseCondition(Hashtable hashtable)
                {
                    return !card.Owner.GetBattleAreaPermanents().Some(permanet =>
                        permanet.TopCard.EqualsCardName("Image Training"));
                }
            ...
            if (timing == EffectTiming.OptionSkill)
            {
                ...
                {
                    return "[Main] Reveal the top 2 cards of your deck. Add 1 Purple or Blue card among them to the hand. Return the rest at the bottom of your deck. Then, place this card in the battle area.";
                }
                ...
                IEnumerator ActivateCoroutine(Hashtable _hashtable)
                {
                    yield return ContinuousController.instance.StartCoroutine(CardEffectCommons.SimplifiedRevealDeckTopCardsAndSelect(
                        ...
                        new SimplifiedSelectCardConditionClass(
                            ...
                            message: "Select 1 Purple or Blue card.",
            ...
            if (timing == EffectTiming.OnDeclaration)
            {
                ...
                string EffectDiscription()
                {
                    return "[Main] <Delay> - 1 of your Digimon may digivolve into a Purple or Blue Digimon card in the hand with the digivolution cost reduced by 2.";
                }
