...
using System;
using Photon.Pun;
public class BT4_033 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnEnterFieldAnyone)
        {
            ...
            {
                return "[When Digivolving] <Digi-Burst 2> (Trash 2 of this Digimon's digivolution cards to activate the effect below.) - Return 1 of your opponent's level 5 or lower Digimon to its owner's hand. Trash all of the digivolution cards of that Digimon.";
            }
