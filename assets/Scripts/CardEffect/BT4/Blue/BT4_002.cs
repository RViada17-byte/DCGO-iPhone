...
public class BT4_002 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnAllyAttack)
        {
            ...
            {
                return "[When Attacking] Trash the digivolution card at the bottom of 1 of your opponent's Digimon with a level of 4 or less.";
            }
