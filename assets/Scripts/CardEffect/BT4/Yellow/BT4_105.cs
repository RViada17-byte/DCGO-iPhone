...
public class BT4_105 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OptionSkill)
        {
            ...
            {
                return "[Main] Place 1 of your Digimon on top of your security stack face down. Trash all of the digivolution cards of that Digimon.";
            }
        ...
        if (timing == EffectTiming.SecuritySkill)
        {
            ...
            string EffectDiscription()
            {
                return "[Security] Trigger <Recovery +1 (Deck)>. (Place the top card of your deck on top of your security stack.)";
            }
            bool CanUseCondition(Hashtable hashtable)
            {
