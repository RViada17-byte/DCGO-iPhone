...
{
    public class EX6_033 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.None)
            {
                ...
                {
                    if ((targetPermanent.TopCard.ContainsCardName("Terriermon")) || (targetPermanent.TopCard.ContainsCardName("Lopmon")))
                    {
                        return true;
                    }
                    return false;
            ...
            if (timing == EffectTiming.OnAllyAttack)
            {
                ...
                activateClass.SetHashString("DP-2000_EX6_033");
                cardEffects.Add(activateClass);
