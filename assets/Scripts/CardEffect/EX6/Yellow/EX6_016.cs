...
{
    public class EX6_016 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnStartMainPhase)
            {
                ...
                {
                    return "[Start of Your Main Phase] If you have a purple Digimon or Tamer, gain 1 memory.";
                }
                ...
                bool PermanentCondition(Permanent permanent)
                {
                    ...
                    {
                        if (permanent.IsTamer && permanent.TopCard.CardColors.Contains(CardColor.Purple) || permanent.IsDigimon && permanent.TopCard.CardColors.Contains(CardColor.Purple))
                        {
                            return true;
                        }
                    }
            ...
            if (timing == EffectTiming.OnAllyAttack)
            {
                ...
                activateClass.SetHashString("DP-2000_EX6_016");
                cardEffects.Add(activateClass);
