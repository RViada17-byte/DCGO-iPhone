...
{
    public class BT15_094 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.SecuritySkill)
            {
                ...
                CardEffectCommons.AddActivateMainOptionSecurityEffect(card: card, cardEffects: ref cardEffects, effectName: $"Suspend 1 level 6 or lower Digimon, 1 Digimon gains DP +3000 and add this card to hand", effectDiscription: EffectDiscription(), afterMainEffect: AfterMainEffect);
            }
