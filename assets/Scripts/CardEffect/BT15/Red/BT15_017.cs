...
{
    public class BT15_017 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                activateClass.SetUpICardEffect("Delete 1 Digimon with the lowest DP and trash the top card of opponent's security", CanUseCondition, card);
            ...
            {
                ActivateClass activateClass = new ActivateClass();
                activateClass.SetUpICardEffect("Play 1 Digimon or Tamer from hand", CanUseCondition, card);
