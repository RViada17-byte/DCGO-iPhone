...
public class P_032 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnDigivolutionCardDiscarded)
        {
            ...
            activateClass.SetUpICardEffect("Your 1 Digimon gains Jamming", CanUseCondition, card);
            ...
            {
                return "[Your Turn] When this card is trashed due to activating this Digimon's <Digi-Burst>, 1 of your Digimon gains  <Jamming> (This Digimon can't be deleted in battles against Security Digimon) for the turn.";
            }
