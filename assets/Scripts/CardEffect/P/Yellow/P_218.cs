    ...
    public class P_218 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                {
                    return "[On Play] Reveal the top 3 cards of your deck, Add 1 [Entertainment] trait card and 1 [Awakening], [Tool] or [Navi] trait card among them to the hand. Return the rest to the bottom of the deck.";
                }
            ...
            if (timing == EffectTiming.WhenLinked)
            {
                ...
                string EffectDiscription()
                {
                    return "[Your Turn] When any of your Digimon get linked to a [Entertainment], [Tool], or [Navi] trait card, by suspending this Tamer, gain 1 memory.";
                }
                ...
                {
                    return source.EqualsTraits("Entertainment")
