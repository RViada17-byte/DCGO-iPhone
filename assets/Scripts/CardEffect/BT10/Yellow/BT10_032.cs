...
{
    public class BT10_032 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                {
                    return "[On Play] Reveal the top 4 cards of your deck. Add 1 Option card with [Plug-In] in its name and 1 yellow Tamer card among them to your hand. Place the rest at the bottom of your deck in any order.";
                }
            ...
            if (timing == EffectTiming.OnUseOption)
            {
                ...
                activateClass.SetHashString("DP-2000_BT10_032");
                cardEffects.Add(activateClass);
