...
{
    public class BT10_108 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnDiscardLibrary)
            {
                ...
                {
                    return "When this card is trashed from your deck, return it to your hand.";
                }
            ...
            if (timing == EffectTiming.OptionSkill)
            {
                ...
                string EffectDiscription()
                {
                    return "[Main] Delete 1 of your opponent's level 6 or lower Digimon. If there are 10 or more cards in your trash, add 1 to the level of the Digimon you can select with this effect.";
                }
            ...
            if (timing == EffectTiming.SecuritySkill)
            {
                CardEffectCommons.AddActivateMainOptionSecurityEffect(
                    ...
                    effectName: $"Delete 1 level 6 or lower Digimon");
            }
