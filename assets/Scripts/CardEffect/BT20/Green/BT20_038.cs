    ...
    public class BT20_038 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.None)
            {
                ...
                {
                    return targetPermanent.TopCard.ContainsCardName("Pinamon") ||
                           (targetPermanent.TopCard.HasLevel && targetPermanent.TopCard.IsLevel2 && targetPermanent.TopCard.EqualsTraits("ACCEL"));
                }
            ...
            if (timing == EffectTiming.BeforePayCost)
            {
                ...
                {
                    return "[Your Turn] When this Digimon would digivolve into a Digimon card with the [ACCEL] trait, reduce the digivolution cost by 1.";
                }
                ...
                {
                    return source.IsDigimon && source.EqualsTraits("ACCEL");
                }
