...
{
    public class BT13_049 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                {
                    return "[On Play] Reveal the top 3 cards of your deck. Add 1 Digimon card with [Vegetation], [Plant], or [Fairy] in one of its traits and 1 [Yoshino Fujieda] among them to the hand. Place the rest at the bottom of the deck in any order.";
                }
                ...
                {
                    if (cardSource.CardNames.Contains("Yoshino Fujieda"))
                    {
                        return true;
                    }

                    if (cardSource.CardNames.Contains("YoshinoFujieda"))
                    {
                        return true;
                    }
                ...
                IEnumerator ActivateCoroutine(Hashtable _hashtable)
                {
                    yield return ContinuousController.instance.StartCoroutine(CardEffectCommons.SimplifiedRevealDeckTopCardsAndSelect(
                        ...
                        new SimplifiedSelectCardConditionClass(
                            ...
                            message: "Select 1 Digimon card with [Vegetation], [Plant], or [Fairy] in one of its traits.",
                            mode: SelectCardEffect.Mode.AddHand,
                            maxCount: 1,
                            selectCardCoroutine: null),
                        new SimplifiedSelectCardConditionClass(
                            canTargetCondition:CanSelectCardCondition1,
                            message:  "Select 1 [Yoshino Fujieda].",
                            mode: SelectCardEffect.Mode.AddHand,
                            maxCount: 1,
                            selectCardCoroutine: null),
                        },
            ...
            activateClass2.SetHashString("DigivolutionCost-1_BT13_049");
