...
{
    public class BT13_079 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                {
                    return "[On Play] 1 of your purple Digimon gains <Retaliation> until the end of your opponent's turn.";
                }
                    ...
                    if (isExistOnField(card))
                    {
                        if (card.Owner.GetBattleAreaDigimons().Contains(card.PermanentOfThisCard()))
                        {
                            if (CardEffectCommons.HasMatchConditionPermanent(CanSelectPermanentCondition))
                            {
                                ...
                                selectPermanentEffect.SetUpCustomMessage("Select 1 Digimon that will get Retaliation.", "The opponent is selecting 1 Digimon that will get Retaliation.");
