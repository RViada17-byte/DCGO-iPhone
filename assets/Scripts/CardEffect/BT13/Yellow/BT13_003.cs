...
{
    public class BT13_003 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnLoseSecurity)
            {
                ...
                activateClass.SetHashString("Jamming_BT13_003");
                cardEffects.Add(activateClass);

                string EffectDiscription()
                {
                    return "[Your Turn][Once Per Turn] When a card is removed from your security stack, 1 of your Digimon gains <Jamming> for the turn.";
                }
