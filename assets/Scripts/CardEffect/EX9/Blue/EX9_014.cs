...
{
    public class EX9_014 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                activateClass.SetUpICardEffect("Reveal 3, Add 1 [DM] trait, and place 1 [Ver.2] trait under a [DM] digimon", CanUseCondition, card);
                ...
                bool HasVer2Trait(CardSource source)
                {
                    return source.EqualsTraits("Ver.2");
                }
                ...
                IEnumerator ActivateCoroutine(Hashtable hashtable)
                {
                    ...
                    simplifiedSelectCardConditions:
                        new SimplifiedSelectCardConditionClass[]
                        {
                            ...
                            new SimplifiedSelectCardConditionClass(
                                canTargetCondition:HasVer2Trait,
                                message: "Select 1 [Ver.2] card.",
