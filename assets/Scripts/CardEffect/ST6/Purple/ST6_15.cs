...
public class ST6_15 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OptionSkill)
        {
            ...
            {
                return "[Main] You may delete 1 of your Digimon to delete 1 of your opponent's level 4 or lower Digimon.";
            }
        ...
        if (timing == EffectTiming.SecuritySkill)
        {
            ...
            string EffectDiscription()
            {
                return "[Security] Delete 1 of your opponent's level 4 or lower Digimon.";
            }
