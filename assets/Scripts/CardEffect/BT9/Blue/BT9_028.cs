...
public class BT9_028 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnEnterFieldAnyone)
        {
            ...
            activateClass.SetUpICardEffect("Unsuspend this Digimon and return 1 level 4 or lower Digimon to hand", CanUseCondition, card);
