...
public class BT9_036 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.None)
        {
            ...
            {
                return targetPermanent.TopCard.CardNames.Contains("Gatomon");
            }
        ...
        if (timing == EffectTiming.OnAllyAttack)
        {
            ...
            {
                return "[When Attacking] If you have 3 or more security cards, 1 of your opponent's Digimon gets -2000 DP for the turn.";
            }
