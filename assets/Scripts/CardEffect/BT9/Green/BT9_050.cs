...
public class BT9_050 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.None)
        {
            ...
            {
                return targetPermanent.TopCard.CardNames.Contains("Leomon");
            }
        ...
        if (timing == EffectTiming.WhenPermanentWouldBeDeleted)
        {
            ...
            activateClass.SetHashString("Substitute_BT9_050");
            cardEffects.Add(activateClass);

            string EffectDiscription()
            {
                return "[All Turns] When this Digimon would be deleted in battle, you may play 1 [Leomon] from this Digimonfigivolution cards without paying its memory cost.";
            }
